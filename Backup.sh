...
Das Backup-Verzeichnis (im Skript BACKUP_DIR genannt) gibt das Verzeichnis an in dem das Archiv erstellt werden soll
...
# Author : Ivan Ishutin
# E-Mail : ishutiniv@elektronikschule.de
# Version: v01
